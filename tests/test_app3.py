...
class TestRestaurants(unittest.TestCase):
    ...
    def test_get_restaurant_info_with_query(self):
        response = self.client.get('/restaurants/search?q=momo')
    ...
    def test_get_restaurant_info_without_query(self):
        response = self.client.get('/restaurants/search')
